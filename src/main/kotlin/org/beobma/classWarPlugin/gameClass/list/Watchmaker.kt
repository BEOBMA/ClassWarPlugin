...
class WatchmakerOrangeSkill : Skill() {
    override val name = "<bold>시간 반전 영역"
    override val description = listOf(
        "<gray>현재 위치에 5초 동안 시간 반전 영역을 배치한다.",
        "<gray>시간 반전 영역에 위치한 아군과 적의 수에 비례하여 현재 시간대의 지속 시간이 느리게 감소한다. (1명당 25%, 최대 100%)",
...
class WatchmakerYellowSkill : Skill() {
...
class WatchmakerPassiveOne : Passive() {
...
class WatchmakerPassiveTwo : Passive() {
