...
class Hitman : GameClass() {
    ...
    override val description = listOf(
        "<dark_gray>전략적 암살자",
        "",
        "<gray>적과 대면하는 일 없이 적을 암살하는데 특화되어있습니다."
    )
    override val classItemMaterial = Material.NETHERITE_HELMET
    override val weapon = HitmanDagger()
...
class HitmanDagger : Weapon() {
    override val name = ""
    override val description = listOf("")
    override val material = Material.AIR
}

class HitmanRedSkill : Skill() {
