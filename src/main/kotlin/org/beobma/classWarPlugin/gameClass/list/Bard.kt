...
class Bard : GameClass() {
    ...
    private class RedSkill : Skill() {
        ...
        override val description = listOf(
            ...
            "",
            "<gray>사용 시 자신의 <gold><bold>이동 속도가 20% 증가</bold><gray>한다.",
    ...
    private class OrangeSkill : Skill() {
        ...
        override val description = listOf(
            ...
            "<gray>실패 시 스킬 지속을 종료하며 재사용 대기 시간을 적용한다.",
            "",
            "<gray>스킬 재사용 성공 시 자신의 <green><bold>체력을 2 회복</bold><gray>시킨다."
        )
        override val cooldown = 20
    ...
    private class YellowSkill : Skill() {
        ...
        override val description = listOf(
            ...
            "<gray>실패 시 스킬 지속을 종료하며 재사용 대기 시간을 적용한다.",
            "",
            "<gray>연주를 지속하는 한, 자신을 {keyword:Untargetability} 상태로 만든다.",
