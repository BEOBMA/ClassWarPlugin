...
class Elementalist : GameClass(), GameStatusHandler, GameEndHandler, PlayerDeathHandler,
    ...
    private inner class RedSkill : Skill() {
        ...
        override val description = listOf(
            ...
            "<gray>저장된 원소를 발현시킨다.",
            "<gray> - 발현:",
            "<gray>  - 흙: 암석을 발사하여 처음 적중한 적에게 {g:damage:4}의 피해를 입히고 밀쳐낸다.",
            "<gray>  - 불: 화염구를 발사하여 처음 적중한 적에게 {g:damage:3}의 피해를 입히고 {g:duration:3}초간 {keyword:Burn} 상태로 만든다.",
            "<gray>  - 물: 물로 만들어진 창을 발사하여 적중한 최대 2명의 적에게 {g:damage:2.5}의 피해를 입히고 이동 속도를 {g:speed:10}% 감소시킨다.",
            "<gray>  - 공기: 압축된 공기를 발사하여 적중한 모든 적에게 {g:damage:2}의 피해를 입힌다. 이 피해는 방어력을 20% 무시한다.",
        )
    ...
    private inner class OrangeSkill : Skill() {
        ...
        override val description = listOf(
            ...
            "<gray>  - 물: 자신의 위치에 5초간 물의 영역을 만들어 적의 이동 속도를 {g:speed:20}% 감소시키고 1초마다 자신의 체력을 {g:healing:1} 회복한다.",
    ...
    private inner class YellowSkill : Skill() {
        ...
        override val description = listOf(
            ...
            "<gray>저장된 원소에 감응한다.",
            "<gray> - 감응:",
            "<gray>  - 흙: {g:duration:3}초간 자신이 받는 피해가 {g:power:20}% 감소하고, 자신의 이동 속도가 {g:speed:20}% 감소한다.",
            "<gray>  - 불: 바라보는 방향으로 빠르게 돌진하며, 지나간 경로에 3초간 불길을 남긴다. 불길에 닿은 적은 {g:duration:1}초간 {keyword:Burn} 상태가 된다.",
    ...
    private class PassiveTwo : BasePassive() {
        ...
        override val description = listOf(
            ...
            "<gray>  - 공기 → 불: 불 원소를 소모한 스킬 적중 시 큰 폭발이 발생하여 추가 피해를 {g:damage:2} 입힌다.",
            "<gray>  - 불 → 물: 물 원소를 소모한 스킬 적중 시 적중한 위치에 3초간 지속되는 증기구름이 생성된다.",
            "<gray>  - 물 → 불: 불 원소를 소모한 스킬 적중 시 대상의 이동 속도 감소 효과와 {keyword:Burn} 상태가 제거되고 {g:damage:2}의 {keyword:TrueDamage}를 입힌다.",
            "<gray>  - 불 → 흙: 흙 원소를 소모한 스킬 효과가 불 원소의 특성도 갖게 효과가 변한다.",
            "<gray>  - 흙 → 불: 불 원소를 소모한 스킬 적중 시 적중한 위치 아래에서 1초 후 추가 폭발이 발생하여 {g:damage:2}의 피해를 입히고 공중으로 띄운다.",
            "<gray>  - 물 → 흙: 흙 원소를 소모한 스킬의 효과에 닿거나 영향을 받은 적의 이동 속도가 {g:speed:50}% 추가로 감소한다.",
            "<gray>  - 흙 → 물: 물 원소를 소모한 스킬 적중 시 {g:duration:4}초간 대상이 받는 피해를 {g:power:15}% 증가시킨다.",
            ...
            "<gray>  - 공기 → 흙: 흙 원소를 소모한 스킬 적중 시 대상을 넉백시키는 대신 지면으로 떨어트리고 {g:duration:3}초간 {keyword:Fix}시킨다.",
        )
    }
    ...
    private class PassiveFour : BasePassive() {
        ...
        override val description = listOf(
            ...
            "<gray>    - 폭풍은 주변 적을 끌어당기고, 초당 {g:damage:0.25}의 피해를 입히며 간헐적으로 번개가 떨어져 {g:damage:1}의 피해를 입힌다.",
            "<gray>  - 흙 ↔ 물 ↔ 공기: 마지막 원소를 소모한 스킬 사용 시 4초간 자신 주변에 생명의 영역을 생성한다.",
            "<gray>    - 생명의 영역에서 자신은 초당 체력을 {g:healing:1} 회복하고, 적의 이동속도가 {g:speed:20}% 감소한다.",
            "<gray>  - 흙 ↔ 불 ↔ 공기: 마지막 원소를 소모한 스킬이 적중한 위치에 대규모 분화를 일으킨다.",
            "<gray>    - 지면이 폭발하여 적을 공중으로 띄우며 {g:damage:2}의 피해를 입히고, 암석 파편이 낙하하여 파편당 {g:damage:1}의 피해를 입힌다.",
            "<gray>  - 흙 ↔ 불 ↔ 물  : 마지막 원소를 소모한 스킬에 적중한 모든 적을 1.5초간 흑요석 감옥에 가둔다.",
            "<gray>    - 자신은 {g:duration:4}초간 <aqua><bold>{g:shield:4}의 피해를 막는 {keyword:Shield}을 얻는다.",
        )
    }
}
