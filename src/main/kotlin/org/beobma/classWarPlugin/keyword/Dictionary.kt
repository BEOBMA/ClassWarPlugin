...
object Dictionary {
    val dictionary: Map<Keyword, String> = EnumMap<Keyword, String>(Keyword::class.java).apply {
        put(
            Keyword.Vibration,
