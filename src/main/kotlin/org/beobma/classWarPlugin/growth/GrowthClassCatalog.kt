...
object GrowthClassCatalog {
    val styles: Map<String, GrowthCombatStyle> = buildMap {
        ...
        register(GrowthCombatStyle.BASIC, "agent assassin avenger berserker blacksmith brave con-artist crossbow damocles darkness dwarf error exodia feather general-person ghost grass hero high-jumper just-light knight lucky-one mercurius neptune peanuts refugees roulette shy-person stalker tonic train-carriage writer")
