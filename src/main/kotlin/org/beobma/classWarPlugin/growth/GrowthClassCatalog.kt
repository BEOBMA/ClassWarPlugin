...
object GrowthClassCatalog {
    val styles: Map<String, GrowthCombatStyle> = buildMap {
        ...
        register(GrowthCombatStyle.ABILITY, "back-room charger contractor death-note devastating-blow elementalist geometer hacker ice-wizard land-wizard lightning-wizard light-wizard mars meteor parasite pat-and-matt phantom portal-gun rainbow-bridge thunderclap-flash tour train trapper uranus warcorrespondent warlock watchmaker weapon-master wounds-wind")
